  ...
  projects: [
    {
      ...
      description: "* Desarrollé la arquitectura completa de una punto de venta web diseñada para centralizar la gestión de ventas, inventarios y reportes de negocio.\n* Diseñé el modelo relacional e implementé el backend con Supabase.\n* Implementé un sistema estricto de roles mediante POO para garantizar la seguridad del sistema al delimitar el flujo de información mediante permisos.\n* Diseñé las interfaces de usuario para el ciclo completo de negocio: caja, cocina, corte de caja, catálogo de productos, reportes y gestión de usuarios.",
      ...
      url: "https://www.animarex.xyz/sistema/login",
      repo: "https://github.com/AproachingDark1889/avivamiento-webpage",
    },
    {
      title: "PuntoRed",
      role: "Full-Stack Developer",
      description: "* Arquitectura Full-Stack de un sistema transaccional, implementando el backend en PHP como un proxy seguro para la integración directa con la API de Gestopago y SQL para almacenar la información de referencias de pago generadas.\n* En esta prueba técnica desarrollé una interfaz escalable con gestión de estado mediante Redux Toolkit y RTK Query.\n* Configuré un protocolo de seguridad integrando un middleware de autenticación y manejo centralizado de errores.\n* Algunas de las funciones son: procesamiento masivo de cancelaciones, creación de referencias de pago, exportación documental (PDF/CSV) y dashboards analíticos.",
      highlights: ["Manejo centralizado de errores y estado eficiente", "Integración con proveedores fintech y transformación de contratos"],
      stack: "React 18, TypeScript, Vite, Tailwind, Redux Toolkit",
      url: "https://boutiquest.shop/login",
      repo: "https://github.com/FranciscoArias041/PUNTO-RED",
    },
    {
      title: "TradingIA",
      role: "Autor / Full-Stack",
      description: "Plataforma de monitoreo de mercados en tiempo real conectada a Binance, Coinbase y KuCoin mediante WebSockets. Para construirla utilicé React 18, TypeScript y Tailwind en la interfaz, apoyado por un servidor en Node.js y Socket.IO para procesar los datos continuamente.",
      highlights: ["Sistema de alertas y notificaciones en tiempo real", "Backend con Node.js y Socket.IO para gestión de conexiones"],
      stack: "React, TypeScript, Tailwind, Node.js, Socket.IO",
      url: "https://trading.animarex.xyz",
      repo: "https://github.com/FranciscoEmmanuel1998/TradingIA",
    },
    {
      title: "Dashboard de Ventas Corporativo",
      role: "Full-Stack Developer",
      description: "* Construí una aplicación para centralizar la información de ventas de múltiples sucursales.\n* Desarrollé una API propia conectada a SQL Server.\n* Implementé una interfaz responsiva con Tailwind CSS, integrando filtros dinámicos y exportación de datos.",
      highlights: ["Análisis de KPIs en tiempo real con Chart.js", "API RESTful propia con Next.js y SQL Server"],
      stack: "Next.js 14, TypeScript, SQL Server, Tailwind CSS, Chart.js",
      url: "https://boutiquest.shop/dashboard/",
      repo: "https://github.com/AproachingDark1889",
    },
  ],
  ...
  labProjects: [
    {
      ...
      desc: "Plataforma interactiva de presentación, chatbot multi-personalidad, Generador de versiculos biblicos, editor de notas y más.",
      tags: ["React 18", "TypeScript", "Radix UI", "Gamificación"],
      url: "https://animarex.xyz",
      repo: "https://github.com/FranciscoEmmanuel1998/Portafolio-DIST",
    },
    {
      title: "Museo Matemático",
      desc: "Simulación tipo Big Bang (Atractor de Lorenz 3D, Juego de la vida, partículas estelares) con renderizado utilizando las APIs de HTML5 Canvas y Web Audio.",
      tags: ["Canvas API", "Web Audio", "TypeScript", "React ", "Vite", "Tailwind"],
      url: "https://museo.animarex.xyz",
        ...
        <div className="grid grid-cols-1 md:grid-cols-[210px_1fr] print:grid-cols-[210px_1fr] gap-5 md:gap-5 print:gap-5">
          ...
          <aside className="space-y-4 md:space-y-3 print:space-y-3 mb-6 md:mb-0 print:mb-0">
            <Section title="Contacto">
              ...
              <ContactRow icon={<Globe size={12} />} text="animarex.xyz" href={data.contact.portfolio} />
              ...
              <ContactRow icon={<Laptop size={12} />} text="Sistemas lanzados a Producción" href={data.contact.production} />
            </Section>
            ...
            {data.labProjects?.length > 0 && (
              <div className="mt-2 border border-[var(--card-border)] rounded p-2" style={{ background: 'var(--tag-bg)' }}>
                <h4 className="text-[10px] md:text-[9px] print:text-[9px] font-bold uppercase tracking-wider mb-2 md:mb-1.5 print:mb-1.5 text-center md:text-left print:text-left" style={{ color: 'var(--primary)' }}>
                  ◆ Laboratorio de Innovación y UI Avanzada
                </h4>
                <div className="grid grid-cols-1 sm:grid-cols-2 print:grid-cols-2 gap-3 md:gap-2 print:gap-2">
                  {data.labProjects.map((lp, i) => (
                    <div key={i} className="flex flex-col">
                      <div className="flex items-center gap-1 mb-0.5">
                        ...
                        {lp.url && <a href={lp.url} target="_blank" className="text-[var(--primary)]"><ExternalLink size={8} /></a>}
                        {lp.repo && <a href={lp.repo} target="_blank" className="text-[var(--text-sec)]"><Github size={8} /></a>}
                      </div>
                      <p className="text-[7.5px] leading-tight opacity-85" style={{ color: 'var(--text-sec)' }}>{lp.desc}</p>
          ...
          <header className="text-center mb-16">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {[
                ...
                <a key={link.text} href={link.url} target="_blank" rel="noreferrer" className="flex items-center gap-2 px-4 py-2 rounded-lg bg-slate-800/50 hover:bg-slate-800 border border-slate-700 hover:border-blue-500/50 transition-all duration-300 text-sm text-gray-300 hover:text-white">
